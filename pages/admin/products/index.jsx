...
export default function Products() {
	...
	useEffect(() => {
		axios.get("https://tindahan-mern.herokuapp.com/adminproducts")
			.then(res => {
		...
		<>
			<div className="admin_products">
				...
				<div className="admin_headers">
					<h3>PRODUCTS</h3>
					<Link href="/admin/products/newproduct/"><div className="addNew"><span>Add new item</span><svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div></Link>
				</div>
				
				<div className="admin_products_wrapper">
					<div className="admin_product p_head">
			 			<div>ID</div>
						<div>Image</div>
			 			<div>Name</div>
			 			<div>Price</div>
				...
				{products.map((val, key) => {
				  return (
				   <div className="admin_product" key={key}>
				 			...
				 			<div>{val.product_price}</div>
				 			<div>{val.product_quantity}</div>
				 			<div>
