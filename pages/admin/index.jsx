				...
				<div className="info_containers">
					...
					<Cashsvg />
						<div className="wrap">
							...
							<div className="bb">₱{totalsales}</div>
						</div>
					</div>
					<Link href="/admin/customers">
						...
						<Customersvg />
							<div className="wrap">
								...
								<div className="bb">{counts.customerCount}</div>
							</div>
						</div>
					</Link>
					<Link href="/admin/products">
						...
						<Store />
							<div className="wrap">
								...
								<div className="bb">{counts.productCount}</div>
							</div>
						</div>
					</Link>
					<Link href="/admin/orders">
						...
						<Creditcard />
							<div className="wrap">
								...
								<div className="bb">{counts.orderCount}</div>
							</div>
						</div>
					</Link>
				</div>
