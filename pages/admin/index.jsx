		...
		<div className="admin">
			...
			<div className="admin_dashboard">
				...
				<div className="info_containers">
					...
					<span>Customers:  {counts.customerCount}</span></div>
					...
					<span>Products:  {counts.productCount}</span></div>
					...
					<span>Orders:  {counts.orderCount}</span></div>
					...
					<span>Total Sales:  ₱{totalsales}</span></div>
