...
export default function products() {
  ...
  useEffect(() => {
    axios
      .post(process.env.BACKEND_BASEURL + "/products/" + product)
      .then(async (res) => {
  ...
  const addToCart = () => {
    ...
    if (cookies.user) {
      ...
      if (quan != 0) {
        ...
        axios
          .post(process.env.BACKEND_BASEURL + "/user/addtocart", {
      ...
      <div className="product">
        ...
        {hasProductInDB ? (
          <div className="product_contents">
            <img
              src={`https://res.cloudinary.com/christianparanas/image/upload/v1617305941/Ecommerce/Products/${productArr[0].product_image}`}
              alt="product image"
            />
            <div className="product_details">
              ...
              <div className="sp">
                <div className="product_price">
                  ₱{productArr[0].product_price.toLocaleString()}
                </div>
                <div className="stock">
                  STOCK: {productArr[0].product_quantity}
                </div>
              </div>
              <div className="description">
                {productArr[0].product_description}
              </div>
              <div className="operate">
                ...
                <div onClick={addToCart} className="addtocart_btn">
                  Add to cart
                </div>
              </div>
            </div>
