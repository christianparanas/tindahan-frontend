...
export default function cart() {
  ...
  const [successOrderModal, setSuccessOrderModal] = useState(
    "success_order_modal"
  );
  ...
  const placeOrder = () => {
    ...
    axios
      .post(process.env.BACKEND_BASEURL + "/user/placeorder", {
          ...
          <div className="order_details">
            ...
            <div className="details">
              ...
              <div className="de">
                ...
                <div className="e">
                  ₱
                  {placedOrderDetailsbool &&
                    placedOrderDetails.total.toLocaleString()}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="placeOrder_modal_content">
              ...
              {cartItems.map((val, key) => {
                return (
                  <div className="overview" key={key}>
                    <div className="aa">
                      ₱{val.cart_p_price} - {val.cart_p_name}
                    </div>
            ...
            <div className="total_payment">
              <div>
                ...
                <div className="total_lbl_money">
                  ₱{subtotal.toLocaleString()}
                </div>
              </div>
              <div
                onClick={placeOrder}
                className="placeOrder_modal_content_placeBtn"
              >
                Place Order
              </div>
            </div>
            ...
            <>
                        ...
                        <div className="itemCart_details">
                          ...
                          <div className="changeRemove">
                            ...
                            <div
                              ...
                              onClick={() => removeCartItem(val.cart_id)}
                            >
                              Remove
                            </div>
                          </div>
              ...
              <div className="total">
                ...
                <div className="placeOrder">
                  <div onClick={openPlaceOrderModal} className="checkout_btn">
                    Check out
                  </div>
                </div>
              </div>
